...
As of this writing, there are 3 major buoyancy driven glider types that are currently utilized by IOOS Regional Associations:
 ...
 + [SeaExplorer](https://www.alseamar-alcen.com/ocean-science-sector/seaexplorer-gliders/): developed through a strategic partnership between [ACRI-ST](https://www.acri-st.fr/), specifically ACRI-in, a subsidiary of ACRI-ST; [ACSA](https://www.alseamar-alcen.com/), the primary robotics manufacturer; [CNRS](https://www.cnrs.fr/en), the French National Centre for Scientific Research; and [IFREMER](https://www.ifremer.fr/en), the French Research Institute for Exploitation of the Sea. The buoyancy-driven glider is now commercialized by [ALSEAMAR](https://www.alseamar-alcen.com/).
...
![Glider Sampling Patterns and Terms](glider-sampling-terminology.png)
 ...
 + **Profile**: Profile: A single, vertically oriented track of a glider, either upward or downward through the water column. A profile represents one-half of a dive and is the fundamental atomic data type used by the NGDAC. All data submitted to the NGDAC is provided as individual profiles, each containing various water column properties or sensor values. Examples of the file format description in [CDL](https://raw.githubusercontent.com/ioos/glider-dac/gh-pages/_nc/template/IOOS_Glider_NetCDF_v2.0.cdl) can be found [here](https://github.com/ioos/glider-dac/tree/gh-pages/_nc/template).
