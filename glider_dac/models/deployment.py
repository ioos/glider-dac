...
class Deployment(Document):
    ...
    def dap(self):
        ...
        dap_url = u"http://%(host)s/thredds/dodsC/%(user)s/%(deployment)s.nc3.nc.ncml" % args
        return dap_url
    ...
    def sos(self):
        ...
        sos_url = u"http://%(host)s/thredds/sos/%(user)s/%(deployment)s.nc3.nc.ncml?service=SOS&request=GetCapabilities&AcceptVersions=1.0.0" % args
        return sos_url
