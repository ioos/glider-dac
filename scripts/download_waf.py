...
def get_iso_doc(iso_url, destination_path):
    '''
...
if __name__ == '__main__':
    ...
    parser.add_argument('erddap', help='URL to ERDDAP, example: http://coastwatch.pfeg.noaa.gov/erddap')
    parser.add_argument('destination', help='Folder to download the ISO documents into')
    args = parser.parse_args()
    main(args.erddap, args.destination)
